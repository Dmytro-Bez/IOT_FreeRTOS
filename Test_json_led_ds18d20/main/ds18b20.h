...
*/
_Bool ds18b20_init(uint8_t GPIO);
...
*/
_Bool ds18b20_is_parasite_power_mode(void);
...
*/
_Bool ds18b20_search_ROM(uint8_t *address);
...
* @return 'true' if a next sensor address was found, 'false' otherwise (it returns 'false' also if there are no sensors on a bus)
*/
_Bool ds18b20_alarm_search(uint8_t *address);
...
*/
_Bool ds18b20_single_get_family_code(uint8_t *code);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_single_get_serial_number(uint8_t *serialNumber);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_get_temperature(float *temperature, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_get_thermometer_resolution(thermRes *res, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_set_thermometer_resolution(thermRes res, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_set_alarm_temperature(int8_t temperatureHigh, int8_t temperatureLow, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_set_alarm_temperature_high(int8_t temperatureHigh, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_set_alarm_temperature_low(int8_t temperatureLow, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_get_alarm_temperature(int8_t *temperatureHigh, int8_t *temperatureLow, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_get_alarm_temperature_high(int8_t *temperatureHigh, uint8_t *address);
...
* @return 'true' if succeeded, 'false' otherwise
*/
_Bool ds18b20_get_alarm_temperature_low(int8_t *temperatureLow, uint8_t *address);
